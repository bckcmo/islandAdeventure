...
void Player::printInfo()
{
	...
	std::cout << "Would you like to look in your backpack? Enter 'y' to look." << std::endl;
	char look = getChar();
...
void Player::removeItem()
{
	...
	}while(validateInput(strInput, input) != 0 || input < 1 || input > pack.getCapacity());
	
	if(this->pack.discard(input - 1) == "canteen")
	{
		water = 0;
	}
